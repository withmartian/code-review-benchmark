...
Building a high-quality, living benchmark is expensive. Generating sufficient data, maintaining independence, keeping the benchmark current, and improving issues over time all require sustained investment. Martian is well-funded and our business doesn't depend on any particular tool winning. This lets us keep the benchmark up to date, independent, and improvable. We also love collaborating with academia — reach out at research@xxx.com.
